...
import { cancelAppointment, confirmAppointment, createAppointment, getAvailableBookingTimes, getNext30DaysAppointmentsCount, getUserAppointments, rejectAppointment } from '../controllers/appointmentController.js';
const router = express.Router();

router.post('/', authenticateToken, createAppointment);
router.get('/', authenticateToken, getUserAppointments);
router.get('/patient-appointments', authenticateToken);
